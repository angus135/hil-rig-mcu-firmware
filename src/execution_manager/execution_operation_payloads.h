 ...
 *      SPI-transmit, CAN-transmit, analogue-output, and raw UART-transmit
 *      payloads are current implementation contracts. The remaining
 *      peripheral payloads document planned encodings and may change as their
