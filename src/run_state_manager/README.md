...
| `execute <ticks> [result bytes]` | `ARMED` | Start Flash preparation; automatically enter `EXECUTION` when ready |
...
transitions. Host-driven requests, Execution Manager completion, result
