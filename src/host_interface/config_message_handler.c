                           ...
                           DutDriverConfiguration_T*        driver_config )
{
    ...
    {
        driver_config->i2c_channels[i].is_enabled =
            config_message->body.test_configuration.i2c[i].enabled;
                                 ...
                                 DutDriverConfiguration_T*        driver_config )
{
    ...
    {
        driver_config->pwm_capture_channels[i].is_enabled =
            config_message->body.test_configuration.pwm_in[i].enabled;
                                         ...
                                         DutDriverConfiguration_T*        driver_config )
{
    ...
    if ( HOST_INTERFACE_Can_Parser( config_message, driver_config ) != HOST_INTERFACE_STATUS_OK )
    {
        return HOST_INTERFACE_STATUS_VALIDATION_FAILED;
    }
    if ( HOST_INTERFACE_I2c_Parser( config_message, driver_config ) != HOST_INTERFACE_STATUS_OK )
    {
        return HOST_INTERFACE_STATUS_VALIDATION_FAILED;
    }
    if ( HOST_INTERFACE_Uart_Parser( config_message, driver_config ) != HOST_INTERFACE_STATUS_OK )
    {
        return HOST_INTERFACE_STATUS_VALIDATION_FAILED;
    }
    if ( HOST_INTERFACE_Spi_Parser( config_message, driver_config ) != HOST_INTERFACE_STATUS_OK )
    {
        return HOST_INTERFACE_STATUS_VALIDATION_FAILED;
    }
    return HOST_INTERFACE_STATUS_OK;
