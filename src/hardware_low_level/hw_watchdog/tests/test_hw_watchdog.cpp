/******************************************************************************
 *  File:       test_hw_watchdog.cpp
 *  Author:     Callum Rafferty
 *  Created:    25-Mar-2026
 *
 *  Description:
 *      Unit tests for the hw_watchdog module using GoogleTest and GoogleMock.
 *      This file validates the public API and behaviour defined in hw_watchdog.h.
 *
 *  Notes:
 ...
 */
class HWWatchdogTest : public ::testing::Test
{
protected:
