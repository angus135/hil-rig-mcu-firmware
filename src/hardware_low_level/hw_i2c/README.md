...
2. Caller triggers transfer with `HW_I2C_Trigger_Master_Receive()` or `HW_I2C_Trigger_Slave_Receive()`
...
- `HW_I2C_Trigger_Slave_Transmit()` / `HW_I2C_Trigger_Slave_Receive()` - Slave operations
